...
from student.trackmanagement import Track, Measurement
...
class Association:
    ...
    def associate(self, track_list: List[Track], meas_list: List[Measurement], KF):
    ...
    def gating(self, MHD: float, sensor: Sensor):
    ...
    def MHD(self, track: Track, meas: Measurement, KF: Filter):
        ...
        return gamma.transpose()*np.linalg.inv(S)*gamma # Mahalanobis distance formula
